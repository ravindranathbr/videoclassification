"""
Django settings for aiadmin project.
...
SECRET_KEY = 'ce=gct1mwnxbkg+_c5%9)wzn@^rkiwjn_$18f(4jm7-0j$f%r9'
...
WSGI_APPLICATION = 'aiadmin.wsgi.application'
